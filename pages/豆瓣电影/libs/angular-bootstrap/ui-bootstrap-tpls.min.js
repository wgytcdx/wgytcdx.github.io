...
})).directive('uibPopoverTemplate', ['$uibTooltip', function (a) { return a('uibPopoverTemplate', 'popover', 'click', { useContentExp: !0 }); }]).directive('uibPopoverHtmlPopup', () => ({
  replace: !0,
  scope: {
