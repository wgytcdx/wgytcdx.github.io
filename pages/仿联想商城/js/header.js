...
//            搜索区的搜索框内a标签的消失于隐藏
const miix5 = document.getElementById('miix5');
const miix5Hide = document.getElementById('miix5Hide');
...
//            banner 左侧商品详细分栏
const navCul = document.getElementById('navCul');
const items = navCul.children;
...
const wrapCar = document.getElementById('wrapCar');
const wrapCarUl = document.getElementById('wrapCarUl');
const wCitems = wrapCarUl.children;
const wClen = wCitems.length;
let num = 0;
const timer = null; const timer1 = null; const timer2 = null; const timer3 = null; const
  timer4 = null;
const circles = document.getElementById('circles');
const circlesItems = circles.children;


//            中部右侧上方 shop_news 的滚动文字块
let timer5 = null; let
  timer6 = null;
const hornScroll = document.getElementById('hornScoll');
...
let imageInitailMove = setInterval('imageMove()', 2000);
